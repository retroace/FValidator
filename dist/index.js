...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"formatString\": () => /* binding */ formatString\n/* harmony export */ });\nvar formatString = function formatString(stringToFormat, format) {\n  var totalStringLength = stringToFormat.length;\n  var seperators = getSeperatorFromFormat(format.substr(0, totalStringLength + 1));\n  var totalSeperators = seperators.length;\n  var addToIndex = 0;\n  var string = stringToFormat;\n\n  for (var i = 0; i < totalSeperators; i++) {\n    if (string[seperators[i][\"index\"]] != seperators[i][\"seperator\"]) {\n      string = insert(string, seperators[i][\"index\"], seperators[i][\"seperator\"]);\n    }\n  }\n\n  return string;\n};\n\nvar getSeperatorFromFormat = function getSeperatorFromFormat(format) {\n  return format.split(\"\").map(function (x, index) {\n    if (![\"-\", \",\", \".\", \"/\", \"\\\\\", \"#\", \"@\", \" \"].includes(x)) {\n      return null;\n    }\n\n    return {\n      index: index,\n      seperator: x\n    };\n  }).filter(function (x) {\n    return x != null;\n  });\n};\n\nvar insert = function insert(str, index, value) {\n  return str.substr(0, index) + value + str.substr(index);\n};\n\n//# sourceURL=webpack://$/./src/util/Transformers.js?");
